...
RSpec.describe ApiController, :type => :controller do
  ...
  describe "GET new" do
    it "assigns a new api as @api" do
      ...
      expect(assigns(:api)).to be_a_new(Api)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created api as @api" do
        post :create, {:api => valid_attributes}, valid_session
        expect(assigns(:api)).to be_a(Api)
        expect(assigns(:api)).to be_persisted
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the api list" do
      api = Api.create! valid_attributes
      delete :destroy, {:id => api.to_param}, valid_session
      expect(response).to redirect_to(api_index_url)
    end
  end
